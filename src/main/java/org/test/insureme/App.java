...
public class App 
{
   ...
   // System.setProperty("webdriver.chrome.driver", "/Users/shubham/Documents/softwares/chrome-driver/chromedriver");
    ...
    driver.get("http://65.0.199.224:8081/contact.html");	
    ...
    //enter details
    //input name
    driver.findElement(By.id("inputName")).sendKeys("sultana");
    Thread.sleep(1000);
    driver.findElement(By.id("inputNumber")).sendKeys("812179079993");
    Thread.sleep(1000);
    driver.findElement(By.id("inputMail")).sendKeys("sultana@xyz.com");
    Thread.sleep(1000);
    ...
    //File destFile = new File("C:\\Users\\Qusam\\eclipse-workspace/test-reports.jpg");
